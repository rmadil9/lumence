...
| BFF (Backend For Frontend) | Splitting the app, ADR 0016 | A thin server that exists only to serve one user interface — it holds sign-in state and shapes data for the screen, and is *not* where product rules live. |
